...
//         <ModalBody p={padding}>{children || body}</ModalBody>
      ...
      >
        ...
        <ModalBody p={padding}>
          {children || body
            ...
            : // <Box
              //   display="flex"
              //   flexDirection={sectionLayout === "horizontal" ? "row" : "column"}
              //   gap="6"
              //   overflowX={sectionLayout === "horizontal" ? "auto" : "visible"}
              // >
              Array.from({ length: numberOfSections }).map((_, idx) => (
                <Box
                  key={idx}
                  minW={sectionLayout === "horizontal" ? "flex" : "auto"}
                  p="4"
                  borderWidth="1px"
                  borderRadius="md"
                ...
                >
                  ...
                  <Box fontSize="sm" color="gray.600">
                    Content for section {idx + 1} goes here...
                  </Box>
                </Box>
              ))
              // </Box>
